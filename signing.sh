...
#
cd /Users/skyline/Downloads/aisibao
zip -r "aaa.ipa" Payload
exit 1
...
if [[ -e ./Payload/$file ]];then
cp -r embedded.mobileprovision ./Payload/$file
else
echo "./Payload/$file 不存在"
fi
done
echo -e "\n**********************************重命名完成**********************************\n"
